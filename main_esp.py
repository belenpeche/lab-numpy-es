...
if a.size == b.size:
    print("Sí, a y b tienen el mismo tamaño.")
else:
    print("No, a y b no tienen el mismo tamaño.")
...
try:
    ...
    print("No se puede sumar a y b debido a:", e)
...
print("Forma de c después de la transposición:", c.shape)
...
print("Forma de d después de la suma:", d.shape)
...
print("Forma de e después de la multiplicación:", e.shape)
